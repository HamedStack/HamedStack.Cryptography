...
/// <summary>
/// Provides methods for computing CRC64 checksums.
/// </summary>
internal static class Crc64
{

    /// <summary>
    /// A table of constants used for CRC64 computations.
    /// </summary>
    ...
    /// <summary>
    /// Computes the CRC64 checksum for a given byte array.
    /// </summary>
    ...
    internal static ulong Compute(byte[] buffer)
    {
        return buffer
            .Aggregate<byte, ulong>(0, (current, t) => 
                Table[(byte) (current ^ t)] ^ (current >> 8));
    }
}