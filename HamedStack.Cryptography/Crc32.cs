...
/// <summary>
/// Provides methods for computing CRC32 checksums.
/// </summary>
internal static class Crc32
{
    /// <summary>
    /// The initial seed value used for CRC computation.
    /// </summary>
    private const uint CRC_SEED = 0xFFFFFFFF;

    /// <summary>
    /// A table of constants used for CRC computations.
    /// </summary>
    ...
    /// <summary>
    /// Computes the CRC32 checksum for a given byte array.
    /// </summary>
    /// <param name="buffer">The byte array for which the checksum is to be computed.</param>
    ...
    /// <summary>
    /// Computes the CRC32 checksum for a segment of a byte array.
    /// </summary>
    /// <param name="buffer">The byte array containing the data segment for which the checksum is to be computed.</param>
    /// <param name="offset">The offset into the buffer where the segment starts.</param>
    /// <param name="length">The number of bytes in the segment.</param>
    /// <returns>The computed CRC32 checksum for the specified segment of the byte array.</returns>
